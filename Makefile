...
ray_tracing:
	gcc ray_tracing_cpu.c -o ray_tracing_serial -fopenmp -lm -Ofast
	gcc ray_tracing_cpu.c -o ray_tracing_openmp -fopenmp -lm -Ofast -DUSE_OMP 
...
clean:
	rm -f ray_tracing_serial ray_tracing_openmp ray_tracing_gpu_* ray_tracing_multi *.txt
