...
ray_tracing:
	gcc ray_tracing.c -o ray_tracing_serial -fopenmp -lm -Ofast
	gcc ray_tracing.c -o ray_tracing_omp -fopenmp -lm -Ofast -DUSE_OMP 
	...
	${CC} -I -L -lmpi -lmpi_cxx ray_tracing_gpu.cu -o ray_tracing_multi -DUSE_MPI ${CFLAGS}
